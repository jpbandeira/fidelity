...
type Service struct {
	...
	Client     User   `gorm:"foreignKey:ClientUUID;references:UUID;constraint:OnDelete:CASCADE;"`
	...
	Attendant    User   `gorm:"foreignKey:AttedantUUID;references:UUID;constraint:OnDelete:CASCADE;"`
...
type ClientServiceCount struct {
	...
	Client     User   `gorm:"foreignKey:ClientUUID;references:UUID;constraint:OnUpdate:CASCADE,OnDelete:CASCADE;"`
